...
class MNISTDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir: str, batch_size: int = 32, val_split: float = 0.1, random_seed: int = 42):
        super().__init__()
    ...
    def prepare_data(self, *args, **kwargs):
        ...
        Extract, unzip and save as training.pt and test.pt files under '<repo_path>/data/external/MNIST/processed'.
